  ...
  return (
    <PageShell>
      <section className="container py-8 md:py-12">
        ...
        <div className="flex flex-col gap-3 rounded-card border border-border bg-card p-4 lg:flex-row lg:items-center lg:justify-between">
        ...
        <div className="mt-6">
          {view === 'list' ? (
            ...
            <PlacesMap
              pins={(places.data ?? []).map((p) => ({ id: p.id, lat: p.lat, lng: p.lng, label: p.name, sublabel: p.provinceName }))}
              height="600px"
              zoom={6}
            />
          )}
